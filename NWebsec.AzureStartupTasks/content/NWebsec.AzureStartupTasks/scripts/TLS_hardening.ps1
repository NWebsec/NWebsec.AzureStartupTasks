...
$preferredCipherSuitesLog = [string]::Join("`n", $preferredCipherSuitesArr)
$preferredCipherSuites = [string]::Join(",", $preferredCipherSuitesArr)
$clen = $($preferredCipherSuites.Length)
write-output "Using preferred cipher suites ($clen):`n$preferredCipherSuitesLog"
